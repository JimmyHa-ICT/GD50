...
function love.keypressed(key)
    ...
    -- if the key up was press and character is on the ground
    if key == 'up' and characterDY == 0 then
...
function love.draw()
    push:start()
        ...
        love.graphics.draw(characterSheet, characterQuads[currentAnimation:getCurrentFrame()],
                            ...
                            0, -- no rotation
                            direction == 'right' and 1 or -1, 1, -- x, y scale corresponding to center
                            CHARACTER_WIDTH / 2, CHARACTER_HEIGHT / 2) -- center offset corresponding to 0, 0
    push:finish()
end