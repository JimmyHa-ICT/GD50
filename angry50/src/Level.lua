...
function Level:init()
    ...
    -- flag that trigger when player collide with somethings
    self.collided = false
    ...
    function beginContact(a, b, coll)
        ...
        if types['Obstacle'] and types['Player'] then
            ...
            -- trigger the self.collided flag
            self.collided = true
...
function Level:update(dt)
    ...
    -- if player collided with something, disable the player alien split
    if self.collided then
        self.launchMarker.splitable = false
    end
