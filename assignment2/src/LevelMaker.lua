...
function LevelMaker.createMap(level)
    ...
    if #bricks == 0 then
        ...
        -- the sheet may have some locked bricks
        if math.random(1, 2) == 1 and true or false then
            -- the number of bricks is proportion to level
            for i = 1, math.floor(level / 10) do
